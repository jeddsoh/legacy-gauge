...
export default function Industries() {
        ...
        <div className="mt-12 grid grid-rows-4 lg:grid-cols-2 gap-4 max-w-screen-xl mx-auto">
          ...
          >
            ...
            <div
              className="absolute inset-0 -z-30 h-full w-full opacity-100"
              style={{
                backgroundImage: `url('/images/ships.webp')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            ></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V19.5m0 2.25l-2.25-1.313m0-16.875L12 2.25l2.25 1.313M21 14.25v2.25l-2.25 1.313m-13.5 0L3 16.5v-2.25" />
            ...
            <p className="mt-2 text-neutral-200 leading-relaxed">
            From defining immersive gamer experiences to creating dynamic marketplaces, we help top gaming companies lead the way.
            </p>
          </a>
          <a
            className="row-span-1 col-span-1 pt-32 pb-14 px-14 rounded overflow-hidden relative flex flex-col justify-end"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.551 0-5.056.2-7.5.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" />
            ...
            <p className="mt-2 text-neutral-200 leading-relaxed">
            Harness technology and research to capture valuable insights that improve community experiences.
            </p>
          </a>
          <a
            className="row-span-1 col-span-1 pt-32 pb-14 px-14 rounded overflow-hidden relative flex flex-col justify-end"
          ...
          >
            ...
            <div
              className="absolute inset-0 -z-30 h-full w-full opacity-100"
              style={{
                backgroundImage: `url('/images/workers.webp')`,
                backgroundSize: "cover",
                backgroundPosition: "center",
              }}
            ></div>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M14.25 9.75L16.5 12l-2.25 2.25m-4.5 0L7.5 12l2.25-2.25M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z" />
            ...
            <p className="mt-2 text-neutral-200 leading-relaxed">
            We thrive in highly technical environments, understanding the intricacies and infrastructure of fueling productivity.
            </p>
          </a>
        </div>
      </div>
